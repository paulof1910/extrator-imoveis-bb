export default async function handler(req, res) {
  ...
  // Chave da API fica aqui no servidor — nunca aparece para o usuário
...
{"imoveis": [{"tipo": "Garantia ou Busca", "matricula": "...", "area": número ou "-", "unidade": "ha ou m² ou -", "municipio": "...", "uf": "XX", "tipo_imovel": "..."}]}`;
